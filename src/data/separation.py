...
data_processed_dir = Path("data/processed_data/X_train.csv")
data_processed_dir.parent.mkdir(parents=True, exist_ok=True)
X_train.to_csv(data_processed_dir,index = False)

data_processed_dir = Path("data/processed_data/X_test.csv")
data_processed_dir.parent.mkdir(parents=True, exist_ok=True)
X_test.to_csv(data_processed_dir,index = False)

data_processed_dir = Path("data/processed_data/y_train.csv")
data_processed_dir.parent.mkdir(parents=True, exist_ok=True)
y_train.to_csv(data_processed_dir,index = False)

data_processed_dir = Path("data/processed_data/y_test.csv")
data_processed_dir.parent.mkdir(parents=True, exist_ok=True)
