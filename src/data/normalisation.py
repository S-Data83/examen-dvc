...
data_dir = Path("data/processed_data/X_train.csv")
X_train = pd.read_csv(data_dir)

data_dir = Path("data/processed_data/X_test.csv")
...
data_processed_dir = Path("data/processed_data/X_train_scaled.csv")
data_processed_dir.parent.mkdir(parents=True, exist_ok=True)
X_train_scaled.to_csv(data_processed_dir,index = False)

data_processed_dir = Path("data/processed_data/X_test_scaled.csv")
data_processed_dir.parent.mkdir(parents=True, exist_ok=True)
